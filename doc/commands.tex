...
% Hyphenations
\hyphenation{mo-le-cu-lar an-aly-ses an-aly-sis au-to-ma-ti-cally ho-mo-lo-gy}
...
\renewcommand{\maketitle}{\begin{titlepage}%
    ...
    \vskip 85\p@
    \begin{center}
    \includegraphics[width=\textwidth]{figures/amnhlogoblack2.pdf}
    \end{center}
    \vfil
    \null
  \end{titlepage}%
...
Illya Bomash \\ Ward C. Wheeler \\ \bigskip \textbf{Documentation} \\ Ilya T\"emkin \\ Kurt M. Pickett \\ Juli\'an Faivovich \\ Taran Grant \\ William Leo Smith}
...
Computer Science Department, The Graduate School and University Center, The City University of New York \\
\smallskip 
{\it
Le Sy Vinh\\
Ward C. Wheeler\\
...
{\it
Juli\'an Faivovich}\\
Departamento de Zoologia, Instituto de Bioci\^encias, Universidade Estadual Paulista\\
\smallskip
{\it
William Leo Smith}\\
...
\texttt{POY} 4.0.\buildnumber\ Beta. New York, American Museum of
Natural History. Documentation by Var\'on, A., L. S. Vinh, I. Bomash,
W. Wheeler, I. T\"emkin, K. Pickett, J. Faivovich, T. Grant, and
W. L. Smith. \url{http://research.amnh.org/scicomp/projects/poy.php}

\vspace*{0.5cm}

Available online at \url{http://research.amnh.org/scicomp/projects/poy.php}.
...
obligatory values, whereas values of others are optional. In the descriptions of
\poy commands below, the elements of \poy grammar are emphasized in
...
\begin{itemize}
    ...
    \item Primitives are shown in \poycommand{UPPERCASE}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Some examples of its usage.
\end{itemize}
...
\begin{statement} \label{commandorder}
    Command order. The effect of the order of arguments in a command is context
    dependent. If arguments are not logically interconnected, their order is not
    important. For example, commands \poycommand{build(10,randomized)} and
    \poycommand{build(randomized,10)} are equivalent. However, executing
...
%\bibitem{Bremer1988} Bremer, K. 1988. The limits of amino acid sequence data in angiosperm phylogenetic reconstruction.\emph{Evolution} 42: 795-803.
%\bibitem{Farris1970} Farris, J. S. 1970. Methods for computing Wagner trees. \emph{Systematic Zoology} 19: 83-92.
%\bibitem{Felsenstein1985} Felsenstein, J. 1985. Confidence limits on phylogenies: An approach using the bootstrap. \emph{Evolution} 39: 783-791
%\bibitem{Kallersjoetal1992} K\"allersj\"o, M., J.S. Farris, A.G. Kluge, and C. Bult. 1992. Skewness and permutation. \emph{Cladistics} 8, 275-287.
%\bibitem{Farrisetal1996} Farris, J. S., V. A. Albert, M. K\"allersj\"o, D. Lipscomb and A. G. Kluge. 1996. Parsimony jackknifing outperforms neighbor-joining. \emph{Cladistics} 12: 99-124.
%\bibitem{Nixon1999} Nixon, K. C. 1999. The Parsimony Ratchet, a new method for rapid parsimony analysis. \emph{Cladistics} 15: 407-414.
%\bibitem{Cormenetal} Cormen, Thomas H., Charles E. Leiserson and Ronald L. Rivest. \emph{Introduction ot Algorithms} MIT Press, McGraw-Hill Publishing. pp. 1028.
%\bibitem{wheeler2003} Wheeler, W. C. 2003. Implied Alignment. \emph{Cladistics} 19: 261-268.
%\bibitem{goloboff1999} Goloboff, P. 1999. Analyzing large data sets in reasonable times: solutions for composite optima. \emph{Cladistics} 15: 415-428.
%\bibitem{wheeler1999a} Wheeler, W. C. 1999. Fixed character states and the optimization of molecular sequence data. \emph{Cladistics} 15: 379-385.

%\end{thebibliography}

\include{poy3commands}

\printindex{general}{General Index}
\printindex{poy3}{POY 3.0 Command Line Index}
