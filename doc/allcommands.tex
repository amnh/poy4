	...
	can be transformed into \poycommand{breakinv} using \poycommand{transform()}.}
	 {customalphabet}
        ...
        tcm:\poystring)}}
            ...
            input file. (See \poyargument{tcm}.)}
            {}
...
\begin{command}{report}{}
	...
	\begin{argumentgroup}{Terminals and characters}
            ...
            identifiers)}} 
                {Given an argument value \poyargument{(a, b, c)}, report the
                ratio between the all pairs distance and their maximum length,
                between the characters listed in \poyargument{b} and
                \poyargument{c}. If \poyargument{a} is true, then compute the
                complement sequence of all the characters in \poyargument{c}
		...
		\begin{argumentgroup}{Trees}
	     ...
	     {}
            ...
            \argumentdefinition{supports}{\optional{argument}}
                ...
                report. \poyargument{bremer} accepts an optional string argument
