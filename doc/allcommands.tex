...
\begin{command}{search}{}
	...
	\begin{poydescription}
            ...
            shortest tree is found, and an expected cost for the shortest tree.
	\end{poydescription}
	...
	\begin{arguments}
        ...
        memory allocated for the search. \poy \emph{attempts} to consume memory within
        the specified limit, but it may surpass it in certain operations. The lident value expresses the 
        units of memory (\poyargument{gb} for gigabites and \poyargument{mb} for megabites), 
        ...
        the program from overflowing the memory. Under certain circumstances, however, 
