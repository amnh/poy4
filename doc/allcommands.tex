\begin{command}{build}{buildcommand}
	...
	\begin{arguments}
        ...
        \argumentdefinition{branch\_and\_bound}{\optional{\poyfloat}}
            ...
            bound (either tree cost or likelihood score. Instead of building a tree the default heuristic method,}
            {branchandbound} 
   ...
   \poydefaults{trees:10, randomized}
	...
	\begin{poyexamples}
		...
		\poyexample{build(15, as\_is)}
            ...
            {Builds trees using branch\_and\_bound method and keeps up to
...
\begin{command}{calculate\_support}{calculatesupport}
	...
	\begin{poydescription} 
            ...
            Bremer support. The Jackknife and Bootstrap support values are computed as
