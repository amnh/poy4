...
\begin{command}{search}{}
	...
	\begin{arguments}
        ...
        \argumentdefinition{visited}{\obligatory{\poystring}}{Specifies a file
        where all the visited trees with their respective cost should be stored
        in. This argument can be used to collect trees to calculate Bremer
        support values. The use of this argument has tremendous impact in the search
        speed, as printing the trees in the file becomes a bootleneck. See the
        \poycommand{report} command for more information on how to use the file
        produced by this argument.}
