\begin{command}{build}{buildcommand}
	...
	\begin{arguments}
        ...
        \argumentdefinition{branch\_and\_bound}{\optional{\poyfloat}}
            ...
            bound (either tree cost or likelihood score. Instead of building a tree,
        ...
        \argumentdefinition{constraint}{\optional{\poystring}}
            ...
            tree input file.
            file containing a. If no input file is provided, the constraint is calculated as
        ...
        \argumentdefinition{random}{}
            {Generate a tree at random.  All possible trees have equal
            probability.}
            {buildrandom}
...
\begin{command}{fuse}{}
    ...
    \begin{poydescription}
            ...
            genetic algorithm technique avoids being trapped at a local optimum
...
\begin{command}{perturb}{}
	...
	\begin{poydescription} 
        Performs a swap using a temporarily modified (``perturbed'') characters
...
\begin{command}{read}{}
	...
	\begin{statement}
        ...
        tcm:\poystring)}}
            ...
            input file specified by the string argument. (See \poyargument{tcm}.)}
            {}
        ...
        tcm:(\poyint, \poyint))}}
            ...
            \poyargument{tcm} argument. (See \poyargument{tcm}.)}
            {prealigned2}
...
\begin{command}{rename}{}
	...
	\begin{statement}
          ...
          \begin{statement}
            ...
            when importing a terminals file using the command \poycommand{select} or specifying
             a root using the command \poycommand{set}.
          \end{statement}
		...
		\end{argumentgroup}
	      ...
	      \argumentdefinition{STRING}{}
                ...
                {Specifies the names of individual items to be renamed. The first item will be renamed
                as the second item: specifying \texttt{("alpha","beta")} would rename the character or taxon
          ...
          \begin{poyexamples}
        \poyexample{rename(terminals,"synfile")}{This command will rename terminal names
            contained in the synonymy file \texttt{synfile} in all subsequently imported datafiles.}
            \poyexample{rename(terminals,("Mytilus\_sp","Mytilus\_edulis"))}{This command will
            rename terminal file \texttt{Mytilus\_sp} as \texttt{Mytilus\_edulis} in all subsequently
            imported datafiles.}
    \end{poyexamples}
...
\begin{command}{report}{}
	...
	\begin{argumentgroup}{Terminals and characters}
		...
		\begin{argumentgroup}{Trees}
	     ...
	     {}
            ...
            \argumentdefinition{supports}{\optional{argument}}
                ...
                command~\nccross{calculate\_support}{calculatesupport} (however see
                \poyargument{bremer}),
                ...
                \poyargument{jackknife} are needed,
		...
		\begin{argumentgroup}{Other arguments}
	     ...
	     \begin{statement}
	     Extensible Stylesheet Language Transformations (XSLT) stylesheets are used
	     for the transformation of XML output into other XML or human-readable documents.
	     Thus, the original XML output of \poy is not changed but a new document is created based
	     on its content. Because xml output contains all the information regarding data and trees,
	     using XSLT stylesheets greatly expands the capabilities of \poy to use and display this information.
...
\begin{command}{set}{}
	...
	\begin{arguments}
        ...
        \begin{argumentgroup}{Cost Calculation}
            ...
            \poycommand{set} command will be used.}
            ...
            \argumentdefinition{exhaustive\_do}{}
                {Applies a starndard Direct Optimization algorithm for the tree
            ...
            \argumentdefinition{iterative}{}
                {Applies the iterative pass optimization in the tree cost calculations. This improves
                the tree cost estimation but at the expense of a tremendous execution time.
                Use at the very end to polish the final set of trees and perform a final search.}
                {}
	...
	\begin{statement}
	  ...
	  (see and determining edge costs by hand. The cost of the tree found during the search might
	  differ from that obtained by the rediagnosing the same tree (see \nccross{rediagnose}{rediagnose}), but will
	  recover the same tree costs in subsequent rediagnoses.
	  cost. 
	\end{statement}
...
\begin{command}{swap}{swapcommand}
	...
	{During the search, \poy visits a large number of trees. For some applications
	 ...
	 search: for example, to provide backups of the state of a
        ...
        choose any combination of trajectory samples, and they will all can be 
...
\begin{command}{transform}{transformcommand}
	...
	\begin{arguments}
        ...
        \argumentdefinition{sequence\_partition}{\poyint}
...
\begin{command}{use}{}
	...
	\begin{poydescription}
         ...
         selections, trees, and all other data and specifications) that had previously been
