...
module MakeApp (Node : NodeSig.S) 
    ...
    class ['a, 'b] local_optimum_holder results : ['a, 'b] search_manager_sampler = object
                    ...
                    | Some c ->
                           ...
                           | Some cc ->
                                   if c < cc then begin
                                       ...
                                       let _ = Stack.pop results.stack in 
                                       Stack.push [(tree.Ptree.tree, c, Ptree.NoCost)] 
                                       results.stack;
                                   end else ()
