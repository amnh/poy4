...
val cardinal : t -> int
val of_array :
  Data.dynamic_hom_spec -> (Sequence.s * IntMap.key) array -> int -> t
val of_list :
  Data.dynamic_hom_spec -> (Sequence.s * IntMap.key) list -> int -> t
...
val to_single : 'a -> t option -> t -> t -> float * float * t
