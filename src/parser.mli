...
module TransformationCostMatrix : sig
    ...
    val of_channel : 
        ?orientation:bool -> ?use_comb:bool -> int -> FileStream.greader ->
            Cost_matrix.Two_D.m * (int list list)

    val of_channel_nocomb: 
        ?orientation:bool -> int -> FileStream.greader -> Cost_matrix.Two_D.m *
        (int list list)
...
module PAlphabet : sig
    ...
    (int list list) * Cost_matrix.Three_D.m
    end
